...
void CardDatabase::registerDefaults() {
    // ── 打击（修改）──
    {
        ...
        c->imagePath = ":/resources/cards/strike.png";
        // 效果1：无条件 6 伤害
        c->effects.push_back(
    ...
    // ── 防御（修改）──
    {
        ...
        c->imagePath = ":/resources/cards/defend.png";
        // 效果1：无条件 5 格挡
        c->effects.push_back(
    ...
    // ── ★ 新增：随机字母 ──
    {
        ...
        c->imagePath = ":/resources/cards/random_letter.png";
        c->effects.push_back(
    ...
    // ── ★ 新增：随机数字 ──
    {
        ...
        c->imagePath = ":/resources/cards/random_digit.png";
        c->effects.push_back(
    ...
    // ── ★ 清空爆破 ──
    {
        ...
        c->imagePath = ":/resources/cards/clear_burst.png";
        c->effects.push_back(
    ...
    // ── ★ 字母连写 ──
    {
        ...
        c->imagePath = ":/resources/cards/triple_letter.png";
    ...
    // ── ★ 数字差力量 ──
    {
        ...
        c->imagePath = ":/resources/cards/digit_diff_strength.png";
        c->effects.push_back(
    ...
    // ── 测试易伤 ──
    {
        ...
        c->cost = 0;
        c->desc = "给敌人施加 2 回合易伤";
        c->imagePath = ":/resources/cards/vulnerable.png";
    ...
    // ── 测试虚弱 ──
    {
        ...
        c->cost = 0;
        c->desc = "给敌人施加 2 回合虚弱";
        c->imagePath = ":/resources/cards/weak.png";
        c->effects.push_back(Effect(std::make_unique<ApplyStatusAction>(
    ...
    // ── 能力牌：每回合写入随机字母 ──
    {
        ...
        c->imagePath = ":/resources/cards/random_letter_ability.png";
        c->effects.push_back(
    ...
    // ── 能力牌：写入时加格挡 ──
    {
        ...
        c->imagePath = ":/resources/cards/block_on_write_ability.png";
        c->effects.push_back(
    ...
    // ── 技能牌：本回合每打出一张牌造成5伤害 ──
    {
        ...
        c->imagePath = ":/resources/cards/temp_damage_per_card.png";
        c->effects.push_back(
    ...
    // ── 能力牌：专注 ──
    {
        ...
        c->imagePath = ":/resources/cards/focus.png";
        c->effects.push_back(
    ...
    // ── 回费牌：充能脉冲 ──
    {
        ...
        c->imagePath = ":/resources/cards/energy_pulse.png";
        c->effects.push_back(
    ...
    // ── 抽牌：灵光一现 ──
    {
        ...
        c->cost      = 1;
        c->desc      = "抽 2 张牌。";
        c->imagePath = ":/resources/cards/flash.png";
        c->effects.push_back(
    ...
    // ── 灵巧抽牌 ──
    {
        ...
        c->imagePath = ":/resources/cards/swift_draw.png";
        c->effects.push_back(
    ...
    // ── 混沌瓦解 ──
    {
        ...
        c->imagePath = ":/resources/cards/chaos_break.png";
        c->effects.push_back(
